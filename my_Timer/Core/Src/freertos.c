...
void MX_FREERTOS_Init(void) {
  ...
  /* add threads, ... */
  xTaskCreate(RxTask,"RxTask",128,NULL,osPriorityNormal,xRxTask);
  xTaskCreate(TxTask,"TxTask",128,NULL,osPriorityNormal,xTxTask);
